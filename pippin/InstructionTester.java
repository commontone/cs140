...
public class InstructionTester {
	...
	@Test
	// Check FOR using immediate mode
	public void testFORimm() {
		...
		int[] expected = {12293, 7, 3, 4, 5, 6, 7, 8};
		int[] actual = machine.getData();
		actual = Arrays.copyOfRange(actual, 0, 8);
		assertArrayEquals(actual, expected);
		assertEquals(4, machine.getPC());
	}

	@Test
	// Check FOR using direct mode
