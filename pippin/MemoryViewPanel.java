...
public class MemoryViewPanel implements Observer {
	...
	JTextField[] dataDecimal = new JTextField[Memory.DATA_SIZE], dataHex = new JTextField[Memory.DATA_SIZE];
	int lower = -1, upper = -1, previousColor = -1;
	
	public MemoryViewPanel(MachineView mv, int lo, int up) {
		machineView = mv;
		lower = lo;
		upper = up;
